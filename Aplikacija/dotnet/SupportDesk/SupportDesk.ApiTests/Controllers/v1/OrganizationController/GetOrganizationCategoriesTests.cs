...
[TestFixture]
internal sealed class GetOrganizationCategoriesTests : ApiTestsBase
{
    ...
    public async Task Get_WithValidOrganizationId_ShouldReturn200OK()
    {
        ...
        var response = await Client.GetAsync($"{EndpointUrl}/{_organizationAdmin.OrganizationId!.IdValue}/categories");
    ...
    public async Task Get_WithInvalidOrganizationId_ShouldReturn400BadRequest()
    {
        ...
        var response = await Client.GetAsync($"{EndpointUrl}/{Guid.NewGuid()}/categories");
