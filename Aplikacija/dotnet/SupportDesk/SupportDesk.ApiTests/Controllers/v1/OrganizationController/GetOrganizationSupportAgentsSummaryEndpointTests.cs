...
[TestFixture]
internal sealed class GetOrganizationSupportAgentsSummaryEndpointTests : ApiTestsBase
{   
    private const string EndpointUrl = "/api/v1/organization/supportAgentsSummary";
