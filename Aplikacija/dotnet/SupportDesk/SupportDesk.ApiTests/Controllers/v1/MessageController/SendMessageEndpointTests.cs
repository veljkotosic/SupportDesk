...
namespace SupportDesk.ApiTests.Controllers.v1.MessageController;

[TestFixture]
internal sealed class SendMessageEndpointTests : ApiTestsBase
{
    private const string EndpointUrl = "api/v1/message";
    ...
    public async Task Post_WithValidData_ShouldReturn201Created()
    {
        ...
        var request = new SendMessageRequest(_ticket.Id.IdValue, "Test Message");
        ...
        var result = await response.Content.ReadFromJsonAsync<SendMessageCommandResult>();
    ...
    [Test]
    public async Task Post_WithoutPermissions_ShouldReturn403Forbidden() 
    {
        await AuthenticateAs(_customer);
