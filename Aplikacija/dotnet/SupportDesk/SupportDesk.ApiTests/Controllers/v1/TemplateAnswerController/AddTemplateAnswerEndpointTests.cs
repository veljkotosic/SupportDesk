...
[TestFixture]
internal sealed class AddTemplateAnswerEndpointTests : ApiTestsBase
{
    ...
    public async Task Post_WithValidData_ShouldReturn201Created()
    {
        ...
        var request = new AddTemplateAnswerRequest("Test Title", "Test Text");
        ...
        var result = await response.Content.ReadFromJsonAsync<AddTemplateAnswerCommandResult>();
    ...
    public async Task Post_WithInvalidData_ShouldReturn400BadRequest()
    {
        ...
        var request = new AddTemplateAnswerRequest("", "");
