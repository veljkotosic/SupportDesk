...
import SupportAgentSidebar from '@/components/supportAgent/SupportAgentSidebar.vue'
...
withDefaults(
  ...
  {
    activePath: '/supportAgent/dashboard',
  },
)
...
<template>
  <div class="flex h-screen bg-gray-50 dark:bg-gray-950 overflow-hidden">
    <aside class="hidden lg:flex w-60 flex-col bg-white dark:bg-gray-900 border-r border-gray-100 dark:border-gray-800 flex-shrink-0">
      <SupportAgentSidebar :user="user" :active-path="activePath" @navigate="handleNavigate" />
    </aside>
        ...
        <div ref="userMenuRef" class="relative">
          ...
          >
            ...
            <div class="hidden sm:block text-left">
              <p class="text-sm font-medium text-gray-900 dark:text-white leading-tight">{{ user.userName }}</p>
